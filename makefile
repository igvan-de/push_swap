...
#    Updated: 2019/09/04 14:31:40 by igvan-de      ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
CHECKER = checker
PUSH_SWAP = push_swap
SRCS_CHECKER = checker.c operators.c create_stack.c delnode.c chunk.c algorithm.c median.c
SRCS_PUSH_SWAP = checker.c operators.c create_stack.c delnode.c chunk.c algorithm.c median.c
OBJ = $(SRCS:%.c=%.o)
