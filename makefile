...
#    Updated: 2019/09/06 16:44:33 by igvan-de      ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
CHECKER = checker
PUSH_SWAP = push_swap
SRCS_CHECKER = checker.c operators.c stack.c delnode.c chunk.c algorithm.c
SRCS_PUSH_SWAP = checker.c operators.c stack.c delnode.c chunk.c algorithm.c
OBJ = $(SRCS:%.c=%.o)
