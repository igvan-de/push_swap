...
#    Updated: 2019/09/05 15:58:24 by igvan-de      ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
CHECKER = checker
PUSH_SWAP = push_swap
SRCS_CHECKER = checker.c operators.c create_stack.c delnode.c chunk.c algorithm.c
SRCS_PUSH_SWAP = checker.c operators.c create_stack.c delnode.c chunk.c algorithm.c
OBJ = $(SRCS:%.c=%.o)
